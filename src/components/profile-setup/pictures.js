...
class HostelPicturesSetup extends Component {
    ...
    componentDidMount() {
        ...
        axios.get('/getAllGeneralImages/' + data.token)
            .then(
                response => {
                    console.log("4");
                    console.log(response.data)
                    for (var i = 0; i < response.data.Data.length; i++) {
                        ...
                        if (i == 0) {
                            ...
                            if (obj.image != null) {
                                this.setState({
                                    pic1: "http://www.hostinn.pk:3300/api/blockGeneralImage/" + obj.image + "/" + data.token,
                            ...
                            if (obj.image != null) {
                                this.setState({
                                    pic2: "http://www.hostinn.pk:3300/api/blockGeneralImage/" + obj.image + "/" + data.token,
                                    generealPicError: false,
                                    remove_pic2: true,
                                })
                            }
                            ...
                            if (obj.image != null) {
                                this.setState({
                                    pic3: "http://www.hostinn.pk:3300/api/blockGeneralImage/" + obj.image + "/" + data.token,
                                    generealPicError: false,
                                    remove_pic3: true,
                                })
                            ...
                            if (obj.image != null) {
                                this.setState({
                                    pic4: "http://www.hostinn.pk:3300/api/blockGeneralImage/" + obj.image + "/" + data.token,
                                    generealPicError: false,
                                    remove_pic4: true,
                                })
                            }
                            ...
                            if (obj.image != null) {
                                this.setState({
                                    pic5: "http://www.hostinn.pk:3300/api/blockGeneralImage/" + obj.image + "/" + data.token,
                                    generealPicError: false,
                                    remove_pic5: true,
                                })
                            }
                            ...
                            if (obj.image != null) {
                                this.setState({
                                    pic6: "http://www.hostinn.pk:3300/api/blockGeneralImage/" + obj.image + "/" + data.token,
                                    generealPicError: false,
                                    remove_pic6: true,
                                })
                            }
            ...
            .then(
                ...
                response => {
                    if (response.data.Error) {
                        ...
                        if (url == 0) {
                            this.setState({
                                dp: "http://www.hostinn.pk:3300/api/blockGeneralImage/" + response.data.Image + "/" + token,
                                profilePicError: false,
                            })

                        } else if (url == 1) {
                            this.setState({
                                pic1: "http://www.hostinn.pk:3300/api/blockGeneralImage/" + response.data.Image + "/" + token,
                                generealPicError: false,
                                remove_pic1: true,
                            })
                            ...
                            this.setState({
                                pic2: "http://www.hostinn.pk:3300/api/blockGeneralImage/" + response.data.Image + "/" + token,
                                generealPicError: false,
                                remove_pic2: true,
                            })
                            ...
                            this.setState({
                                pic3: "http://www.hostinn.pk:3300/api/blockGeneralImage/" + response.data.Image + "/" + token,
                                generealPicError: false,
                                remove_pic3: true,
                            })
                            ...
                            this.setState({
                                pic4: "http://www.hostinn.pk:3300/api/blockGeneralImage/" + response.data.Image + "/" + token,
                                generealPicError: false,
                                remove_pic4: true,
                            })
                            ...
                            this.setState({
                                pic5: "http://www.hostinn.pk:3300/api/blockGeneralImage/" + response.data.Image + "/" + token,
                                generealPicError: false,
                                remove_pic5: true,
                            })
                            ...
                            this.setState({
                                pic6: "http://www.hostinn.pk:3300/api/blockGeneralImage/" + response.data.Image + "/" + token,
                                generealPicError: false,
                                remove_pic6: true,
                            })
